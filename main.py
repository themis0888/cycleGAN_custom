...
--dataset_dir=cat2dog \
--data_path=/home/siit/navi/data/input_data/image_translation_dataset/ \
--input_nc=3 --output_nc=3 --continue_train=False \
...
parser.add_argument('--data_path', dest='data_path', default='/webtoon/cycleGAN/datasets/', help='path of the dataset')
...
parser.add_argument('--print_freq', dest='print_freq', type=int, default=2000, help='print the debug information every print_freq iterations')
parser.add_argument('--continue_train', dest='continue_train', type=bool, default=False, help='if continue training, load the latest model: 1: true, 0: false')
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint', help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='./sample3', help='sample are saved here')
